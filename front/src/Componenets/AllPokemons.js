...
export default class AllPokemons extends Component {
      ...
      async () => {
        try {
          const response = await fetch(
            "https://backendpokemon-production.up.railway.app/pokemons/" + this.state.search,
            { method: "GET" }
          );
          const json = await response.json();
          this.setState(
  ...
  async handleClickDelete(id) {
    this.setState(
      ...
      async () => {
        try {
          const response = await fetch("https://backendpokemon-production.up.railway.app/pokemons/" + id, {
            method: "DELETE",
          });
          const json = await response.json();
          this.setState(
